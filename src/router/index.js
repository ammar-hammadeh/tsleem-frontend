...
let RegisterFormPages = {
    ...
    children: [{
        ...
        name: "RegisterForm",
        component: () =>
            import("@/views/Auth/RegisterForm.vue"),
        meta: {
...
let GISPage = {
    ...
    },
    {
        ...
        name: "EditLocation",
        component: () =>
            import("@/views/Location/Edit.vue"),
        meta: {
            groupName: "Location",
            middlewares: [Middleware.auth, Middleware.permission, Middleware.signeture],
    ...
    },
    {
        ...
        name: "LocationPage",
        component: () =>
            import("@/views/Location/Show.vue"),
        meta: {
            groupName: "Location",
            middlewares: [Middleware.auth, Middleware.permission, Middleware.signeture],
    ...
    // container
    {
        ...
        name: "NewContainer",
        component: () =>
            import("@/views/Container/New.vue"),
        meta: {
            groupName: "Container",
            middlewares: [Middleware.auth, Middleware.permission, Middleware.signeture],
    ...
    },
    {
        ...
        name: "EditContainer",
        component: () =>
            import("@/views/Container/Edit.vue"),
        meta: {
            groupName: "Container",
            middlewares: [Middleware.auth, Middleware.permission, Middleware.signeture],
    ...
    },
    {
        ...
        name: "ContainerPage",
        component: () =>
            import("@/views/Container/Show.vue"),
        meta: {
            groupName: "Container",
            middlewares: [Middleware.auth, Middleware.permission, Middleware.signeture],
    ...
    // establishments
    {
        ...
        component: () =>
            import("@/views/Establishment/New.vue"),
        meta: {
    ...
    },
    {
        ...
        component: () =>
            import("@/views/Establishment/Edit.vue"),
        meta: {
            groupName: "Establishment",
            middlewares: [Middleware.auth, Middleware.permission, Middleware.signeture],
    ...
    },
    {
        ...
        component: () =>
            import("@/views/Establishment/Show.vue"),
        meta: {
            groupName: "Establishment",
            middlewares: [Middleware.auth, Middleware.permission, Middleware.signeture],
    ...
    // water-tape
    {
        ...
        name: "NewWaterTape",
        component: () =>
            import("@/views/waterTape/New.vue"),
        meta: {
            groupName: "waterTape",
            middlewares: [Middleware.auth, Middleware.permission, Middleware.signeture],
    ...
    },
    {
        ...
        name: "EditWaterTape",
        component: () =>
            import("@/views/waterTape/Edit.vue"),
        meta: {
            groupName: "waterTape",
            middlewares: [Middleware.auth, Middleware.permission, Middleware.signeture],
    ...
    },
    {
        ...
        name: "WaterTapePage",
        component: () =>
            import("@/views/waterTape/Show.vue"),
        meta: {
            groupName: "waterTape",
            middlewares: [Middleware.auth, Middleware.permission, Middleware.signeture],
    ...
    // electrical-meter
    {
        ...
        meta: {
            ...
            middlewares: [Middleware.auth, Middleware.permission, Middleware.signeture],
            permissions: 'electrical-meter-create',
        },
    },
    {
        ...
        meta: {
            groupName: "ElectricalMeters",
            middlewares: [Middleware.auth, Middleware.permission, Middleware.signeture],
            permissions: 'electrical-meter-update',
        },
    },
    {
        ...
        meta: {
            groupName: "ElectricalMeters",
            middlewares: [Middleware.auth, Middleware.permission, Middleware.signeture],
            permissions: 'electrical-meter-index',
        },
    },

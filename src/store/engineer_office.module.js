...
export const engineer_office = {
    namespaced: true,
    state: () => ({
    }),
    actions: {
        delete_engineer_office({ rootState }, item) {
            Vue.swal({
                ...
                if (result.value) {
                    return EnginnerOfficeService.destroy_engineer_office(item.id).then(
                        (response) => {
        ...
        add_engineer_office({ rootState }, data) {
            return EnginnerOfficeService.add_engineer_office(data).then(
                (response) => {
                    console.log(response);
        ...
        update_engineer_office({ rootState, state }, data) {
            return EnginnerOfficeService.edit_engineer_office(rootState.id, data).then(
                (response) => {
                    console.log(response);
                    rootState.form.loader = false;
                    rootState.form.style_form = [];
        ...
        getData({ rootState }, data) {
            ...
            return EnginnerOfficeService.get_categories(rootState.table.paginate.page, formData).then(
                (response) => {

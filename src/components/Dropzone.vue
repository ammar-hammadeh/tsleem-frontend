<template>
  <div
    class="dropzone mb-3 dz-clickable custom-dropzone"
  ...
  >
    ...
    >
      <li class="list-group-item px-0">
        <div class="row d-flex align-items-center li-content">
          <div class="col-md-3">
            <div class="avatar">
              <img class="avatar-img rounded" data-dz-thumbnail />
            </div>
          </div>
          <div class="col-md-7 file-description">
            <p class="mb-1" data-dz-name>...</p>
            <p class="small text-muted mb-0" data-dz-size>...</p>
          </div>
          <div class="col-md-2">
            <button data-dz-remove="true" class="btn btn-sm">
